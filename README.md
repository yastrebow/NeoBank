...
```
cd existing_repo
git remote add origin https://neogit.neoflex.ru/aalekseenko/msa-bank.git
git branch -M main
...
- [ ] [Set up project integrations](https://neogit.neoflex.ru/aalekseenko/msa-bank/-/settings/integrations)
